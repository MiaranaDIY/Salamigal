...
Salamigal.Selector = React.createClass({
  ...
  getInitialState: function () {
    return { value: '',data: [],selectedDevice: [{group: {label: '-', value: '-'}}] };
  },
  ...
  render: function () {
    ...
    return(
      ...
      <Card dev={this.state.selectedDevice} onParamChange={this.handleOnParamChange} onRefreshSelected={this.handleOnRefreshSelected} />
      </div>
    );
  }
});    
